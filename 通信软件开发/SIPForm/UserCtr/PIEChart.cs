...
namespace HZH_Controls.Controls
{
    /// <summary>
    /// Class UCPieChart.
    /// https://blog.csdn.net/kwwwvagaa/article/details/101204346
    ...
    public class UCPieChart : UserControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (width > 0 && pieItems.Length != 0)
            {
                ...
                {
                    Color cItem = pieItems[i].PieColor ;
        ...
        public void SetDataSource(string[] names, int[] values,Color[] colors)
        {
            if (names == null)
            {
